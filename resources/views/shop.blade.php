    	...
    	<div class="container">
     		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
					@php $cartSession = session()->get('cart');
					@endphp
					@foreach($listMenu as $data)
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="<?php echo $data['foto'];?>" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
									...
									<p class="bottom-area d-flex px-3">
										@if(isset($cartSession[$data['id']]))
										@foreach($cartSession as $struct)
									    	@if ($data['id'] == $struct['idMenu'])
											<input type="text" value="{{$struct['quantity']}}">
										...
										@endforeach	
										@else
		    							<a href="{{ url('add-to-cart/'.$data->id) }}" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
										@endif
